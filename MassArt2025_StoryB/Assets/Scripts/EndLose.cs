...
public class EndLose : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (GameHandler.endingNumber == 21){ // CHARGE WITH PIPE
        ...
        else if (GameHandler.endingNumber == 24){ // THROW FIRE AXE
            endTitle.text = "BAD ENDING";
        ...
        else if (GameHandler.endingNumber == 3){ // NEUTRAL ENDING
        ...
        else if (GameHandler.endingNumber == 4){ // BAD ENDING RECEPTION
            endTitle.text = "BAD ENDING";
